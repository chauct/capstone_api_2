  ...
  axios({
    ...
    .then(function (res) {
      ...
      function total() {
        ...
        document.querySelector(".total").innerHTML = "Tổng tiền: $" + total;
      }
      total();
...
//                                 <h3>$${data[i].price}</h3>
//                                 <h3>${data[i].screen}</h3>
//                                 <h3>${data[i].backCamera}</h3>
//                                 <h3>${data[i].frontCamera}</h3>
//                                 <h3>${data[i].desc}</h3>

//                                 <button onclick="add('${data[i].id}')" class="btn-add">Thêm  </button>
//                             </div>
//                         </div>
//                     </a>
//                 </div>
...
function renderCart() {
  ...
  if (cartItem && tbl) {
    ...
    // tbl.innerHTML += `
    // //   <button onclick="clearCart()" class="btn btn-success">Clear1</button>
    //  `;
  }
